...
**এই একটা লাইনই** পুরো অ্যাপের চেহারা ঠিক করে। বিদ্যমান থিমগুলো: `control-room.css`, `tactile.css`, `editorial.css`, `terminal.css`।
...
**`terminal`** — ফসফর CRT। near-black গ্লাস, সবুজ ফসফর টেক্সট, মনোযোগ চাইলে অ্যাম্বার। **সব ফন্ট mono** (`--t-font-sans`-ও), শূন্য radius, শূন্য shadow — বিভাজন কেবল রুল বা ফাঁকা সারি। `--t-app-bg-image`-এ scanline ফিল্ড। Easing `steps()` — রিফ্রেশ সাইকেলের মতো, ইজিং নয়। Ornament = চার কোণে ব্র্যাকেট। ফসফর জ্বলে (ল্যাম্প, তার, প্যাকেটে glow) — এটাই CRT-র ধর্ম।

**`editorial`** — ছাপা পাতা। সাদা স্টক, কালো কালি, মোটা রুল, **শূন্য radius ও শূন্য shadow**। একটাই accent (vermilion `#FF4A1C`)। জোর দেওয়া = কালো ফিলে সাদা টাইপ। Ornament বন্ধ, ল্যাম্প বর্গাকার ও আলোহীন (কাগজে কিছু জ্বলে না), প্যাকেট বর্গাকার, তারের কোণা ৯০°। Category/signal রঙ কাগজের জন্য গাঢ় করা — ওগুলো তথ্য বহন করে বলেই রাখা।
